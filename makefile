...
# 链接选项
LDFLAGS = -lasan ./third_party/lib/libfaiss.a -fopenmp -lopenblas -lpthread -lspdlog -lrocksdb -lroaring -lnuraft -lssl#./third_party/roaring/build/libcroaring-singleheader-source-lib.a
